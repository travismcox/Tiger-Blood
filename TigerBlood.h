...
* File: TigerBlood.h
* Group: Tiger Blood
* Author: Travis Cox, David Millard, Chunyang Yin, Robert Phelps, Jingyu Wang
* Assignment Title:  Group Project: "Tiger Game"
* Assignment Description: This header file uses AI in the Tiger Game to 
    determine which pieces move where.
* Due Date: 4/27/2018
